(function($){
	function crateCommentInfo(obj){
		...
		var el = "<div class='comment-info'><header><img src='"+obj.img+"'></header><div class='comment-right'><h3>"+obj.replyName+"</h3>"
				+"<div class='comment-content-header'><span><i class='Hui-iconfont-shijian'></i>"+obj.time+"</span>";
		
		if(typeof(obj.address) != "undefined" && obj.browse != ""){
			el =el+"<span><i class=''></i>"+obj.address+"</span>";
		}
		...
		if(typeof(obj.osname) != "undefined" && obj.osname != ""){
			el =el+"<span><i class=''></i> 来自:"+obj.osname+"</span>";
		}
		
		if(typeof(obj.browse) != "undefined" && obj.browse != ""){
			el = el + "<span><i class=''></i> "+obj.browse+"</span>";
		}
		if(typeof(obj.replyBody) != "undefined" && obj.replyBody != ""){
