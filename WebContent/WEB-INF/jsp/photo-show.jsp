...
<div class="page-container">
	...
	<div class="portfolio-content">
		<ul class="cl portfolio-area">
			<c:forEach items="${photonamelist}" var="pnl">
					<c:out value="
					<li class='item'>
				<div class='portfoliobox'>
					<div class='picbox'><a href='/ssm_system/photo/${webfilename}/${pnl}' data-lightbox='gallery' data-title='${pnl}'><img src='/ssm_system/photo/${webfilename}/${pnl}'></a></div>
					<div class='textbox'>${pnl} </div>
					</div>
			</li>
