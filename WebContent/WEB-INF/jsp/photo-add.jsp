...
<div class="pd-20">
  <div class="Huiform"><!--  action="addPhoto" method="post" enctype="multipart/form-data"  -->
    <form id="form-photo-add"> 
    	<div class="row">
    	<div class="col-sm-2">
            <p  style="float:right">相册名称：</p>
          </div>
          <div class="col-sm-9">
            <input type="text" class="form-control" value="" placeholder="" id="name" name="name" datatype="*2-16" nullmsg="相册名不能为空">
          </div>
          </div>
          <br>
          <div class="row">
    	<div class="col-sm-2">
          ...
          <div class="col-sm-9">
            <textarea  class="form-control" value="" placeholder="" id="description" name="description" datatype="*2-100" nullmsg="描述不能为空"></textarea>
          </div>
          </div>
          <br>
          <div class="row">
...
var formData = new FormData(document.getElementById("form-photo-add"));
