      ...
      <table class="table table-bg">
        <tbody>
          <tr>
            ...
            <td>
            <input type="hidden" id="id" name="id" value="${newsType.id}"/>  
            <input type="text" style="width:200px" class="input-text" value="${newsType.name}" placeholder="" id="name" name="name"  nullmsg="类型名称不能为空"></td>
          </tr>
          <tr>
            <th width="100" class="text-r"><span class="c-red">*</span> 类型描述：</th>
            <td><input type="text" style="width:200px" class="input-text" value="${newsType.description}" placeholder="" id="description" name="description"  nullmsg="类型描述不能为空"></td>
          </tr>
          <tr>
	...
	$("#form-newstype-edit").validate({
		...
		submitHandler:function(form){
			$.ajax({
		        ...
		        cache : false,
		        type : 'POST',
		        data : $("#form-newstype-edit").serialize(),
		        url : "editNewsType",//请求的action路径  
		        dataType: 'json',
		        success:function(data) { //请求成功后处理函数。
					...
					if(data.msg == 'success'){
						...
						layer.msg('提交失败!请检查，很可能是该类型已经被占用。',{icon:1,time:2000});
					}
		        },
